            ...
            foreach ($people as $people) {
                ?>
                    <tr>
                        ...
                        <td class="icon_range"><a href="vendor/delete.php?id=<?= $people[0] ?>"><img class="table_icon" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSdV34bVyKdVZAKAXsryW4F0QDnv830tB03A&usqp=CAU" alt="удалить" title="удалить"></a></td>
                    </tr>
                <?php
            }
        ?>
