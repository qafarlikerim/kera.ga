            ...
            foreach ($people as $people) {
                ?>
                    <tr>
                        ...
                        <td><div id="table"><a href="vendor/delete.php?id=<?= $people[0] ?>"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSdV34bVyKdVZAKAXsryW4F0QDnv830tB03A&usqp=CAU" alt="удалить" title="удалить"></a></div></td>
                    </tr>
                <?php
            }
        ?>
