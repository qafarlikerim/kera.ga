            ...
            foreach ($people as $people) {
                ?>
                    <tr>
                        ...
                        <td><a href="vendor/delete.php?id=<?= $people[0] ?>"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSdV34bVyKdVZAKAXsryW4F0QDnv830tB03A&usqp=CAU" alt="удалить" title="удалить" width="10%"></a></td>
                    </tr>
                <?php
            }
        ?>
