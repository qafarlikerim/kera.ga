            ...
            foreach ($people as $people) {
                ?>
                    <tr>
                        ...
                        <td><a href="vendor/delete.php?id=<?= $people[0] ?>"><img src="https://play-lh.googleusercontent.com/pbfKWZAmdO7W0Vg9VnYO4iKP1mTB8nF1dp32oSrXHBpsIV7HwBhrl_TTih4ol419SF0" alt="удалить" title="удалить" width="20%"></a></td>
                    </tr>
                <?php
            }
        ?>
