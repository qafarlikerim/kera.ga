            ...
            foreach ($people as $people) {
                ?>
                    <tr>
                        ...
                        <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon" href="vendor/delete.php?id=<?= $people[0] ?>" rel="tooltip" title="delete"><i class="fa fa-trash"></i></a></div>
                    </tr>
                <?php
            }
        ?>
